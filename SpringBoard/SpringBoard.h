...
@class NSDate, NSDictionary, NSMutableArray, NSMutableSet, NSNumberFormatter, NSObject<OS_dispatch_source>, NSSet, NSTimer, SBAppContextHostManager, SBApplication, SBUIController, UIWindow;
...
@interface SpringBoard : UIApplication <MCProfileConnectionObserver, UIApplicationDelegate>
{
    ...
    UIWindow *_simulatedBlankingWindow;
    ...
    BOOL _thermalJetsamCPUSamplingRunning;
...
- (void)registerBlockForMemoryPressureSubsiding:(id)arg1;
...
- (void)_openURLCore:(id)arg1 display:(id)arg2 animating:(BOOL)arg3 sender:(id)arg4 additionalActivationFlag:(unsigned int)arg5;
- (void)_applicationOpenURL:(id)arg1 withApplication:(id)arg2 sender:(id)arg3 publicURLsOnly:(BOOL)arg4 animating:(BOOL)arg5 additionalActivationFlag:(unsigned int)arg6;
- (void)applicationOpenURL:(id)arg1 withApplication:(id)arg2 sender:(id)arg3 publicURLsOnly:(BOOL)arg4 animating:(BOOL)arg5 needsPermission:(BOOL)arg6 additionalActivationFlag:(unsigned int)arg7;
