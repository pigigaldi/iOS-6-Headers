...
@class BBObserver, NSArray, NSMutableArray, NSMutableDictionary, NSTimer, SBApplication, SBBulletinClearButton, SBBulletinListTabView, SBBulletinListView, SBWeeApp, SBWeeAppPresentationView;
