...
@class MPAudioDeviceController, NSArray, NSMutableArray, NSMutableDictionary, SBAnimationStepper, SBApplication, SBDismissOnlyAlertItem, SBShowcaseController, SBSwitchAppGestureView, SBUIRootView, SBWallpaper, SBWallpaperView, UIStatusBar, UIStatusBarCorners, UIView, UIWindow;
...
- (BOOL)_revealShowcase:(id)arg1 revealMode:(int)arg2 duration:(double)arg3 from:(id)arg4 to:(id)arg5;
